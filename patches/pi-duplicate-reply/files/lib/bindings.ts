...
export function registerTelegramLifecycleRuntimeHooks({
  ...
  >({
    ...
    async waitForActivityIdle() {
      const assistantIdle = assistantOutputRuntime.waitForIdle(true);
